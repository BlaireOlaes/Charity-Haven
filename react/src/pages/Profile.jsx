...
function Home() {
    ...
    return (
        ...
        <img src="charitycover.jpg" alt="Profile Picture" className="profile-picture" /> */}
         <div className="forhr">
        <hr style={{ marginTop: '1px', border: 'none', height: '1px', backgroundColor: 'white' }} />
    </div>
        <div className="user-infos">
            <span className="charityhaven-username">CHARITY HAVEN OFFICIAL PAGE</span>
        </div>
    </div>
    <div className="forhr">
        <hr style={{ marginTop: '20px', border: 'none', height: '1px', backgroundColor: 'white' }} />
    </div>
    <section className="newsfeed-content">
        ...
        <div className="posts-container">
            {posts.filter((post) => !post.deleted_at).map((post) => (
                <div key={post.id} className="post">
                    <div className="user">
                        ...
                        <p>
                            <span>
                                {new Date(post.upload_time).toLocaleString()}
                            </span>
                        </p>
                    </div>
